...
assert.match(main,/20260918-bbs-designer-anchor-r2/,'Main module must cache-bust the updated BBS page.');
assert.match(page,/20260918-bbs-designer-anchor-r2/,'BBS page must cache-bust the updated Designer module.');
assert.match(index,/public\/js\/main\.js\?v=20260918-bbs-designer-anchor-r2/,'HTML entry point must cache-bust the updated main module.');
