...
assert.match(main,/20260918-bbs-native-raster-r1/,'Main module must cache-bust the updated BBS page.');
assert.match(page,/20260918-bbs-native-raster-r1/,'BBS page must cache-bust the updated Designer and output modules.');
assert.match(index,/public\/js\/main\.js\?v=20260918-bbs-native-raster-r1/,'HTML entry point must cache-bust the updated main module.');
