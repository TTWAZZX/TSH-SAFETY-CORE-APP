...
assert.match(main,/20260921-bbs-artwork-fidelity-r3/,'Main module must cache-bust the updated BBS page.');
assert.match(page,/20260921-bbs-artwork-fidelity-r3/,'BBS page must cache-bust the updated Designer and output modules.');
assert.match(index,/public\/js\/main\.js\?v=20260921-bbs-artwork-fidelity-r3/,'HTML entry point must cache-bust the updated main module.');
