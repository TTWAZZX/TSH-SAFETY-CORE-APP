...
for(const source of [node,php]){assert.match(source,/admin\/card-designer\/runtime/);assert.match(source,/BBS_DESIGNER_ADMIN_ONLY_REQUIRED/);assert.match(source,/visual_card_designer_enabled/);assert.match(source,/visual_card_designer_rendering_enabled/);assert.match(source,/FOR UPDATE/);}
