...
function cases(adminToken, userToken) {
    ...
    const adminRead = [
        ...
        ['Activity target coverage matrix', '/activity-targets/coverage-matrix'],
    ...
    const userBlocked = [
        ...
        ['User blocked from activity target coverage matrix', '/activity-targets/coverage-matrix'],
        ['User blocked from KY reminder queue', '/ky/reminder-queue'],
        ['User blocked from Yokoten dept completion', '/yokoten/dept-completion'],
