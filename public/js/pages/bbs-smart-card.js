...
import { designerPrintDocument } from '../utils/bbs-card-print.js?v=20260914-bbs-typography-align-r1';
...
async function openCardTemplatePreview(kind,id,options={}){
    ...
    try{
        ...
        const [asset,departmentContext]=await Promise.all([loadCardTemplateAsset(kind,id),contextTemplate?departmentPrintContext(contextTemplate):Promise.resolve(null)]);
        const assessment=assessCardTemplate(kind,template,asset,{intent:options.intent||'',employee,departmentContext});
