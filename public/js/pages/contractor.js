...
function _renderDashboard() {
    ...
    <div class="space-y-6">
        ...
        <div class="grid grid-cols-1 lg:grid-cols-5 gap-6">
            ...
            <!-- Recent uploads (3/5) -->
            <div class="lg:col-span-3 ds-section overflow-hidden">
...
function _showAccidentForm(record = null) {
    ...
    document.getElementById('contractor-accident-form').addEventListener('submit', async e => {
        e.preventDefault();
...
function _buildEmptyState(color, title, sub) {
    return `
    <div class="ds-empty-state p-12 text-center">
