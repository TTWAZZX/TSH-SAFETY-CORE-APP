                ...
                <div class="flex flex-wrap gap-3 items-center">
                    <div class="relative group">
                        <div class="absolute inset-y-0 left-0 pl-3 flex items-center pointer-events-none">
                            <svg class="w-4 h-4 text-slate-400 group-focus-within:text-emerald-500 transition-colors" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M21 21l-6-6m2-5a7 7 0 11-14 0 7 7 0 0114 0z"/></svg>
                        </div>
                        <input type="text" id="search-emp" placeholder="ค้นหาชื่อ, รหัส, หรือตำแหน่ง..." 
                            class="pl-10 pr-4 py-2 bg-white border border-slate-300 rounded-lg text-sm focus:outline-none focus:ring-2 focus:ring-emerald-500 focus:border-transparent w-64 shadow-sm transition-all">
                    </div>
        ...
        <tr class="hover:bg-slate-50 transition-colors group">
            ...
            <td class="px-6 py-4 whitespace-nowrap text-right text-sm font-medium">
                <div class="flex justify-end gap-2 opacity-60 group-hover:opacity-100 transition-opacity">
                    <button onclick="editEmployee('${emp.EmployeeID}')" class="text-emerald-600 hover:text-emerald-900 bg-emerald-50 hover:bg-emerald-100 p-1.5 rounded-md transition-colors" title="แก้ไข">
    ...
    try {
        ...
        const html = `
            <form id="emp-form" onsubmit="saveEmployee(event)" class="space-y-6">
                ...
                <div class="bg-emerald-50/50 p-4 rounded-lg border border-emerald-100 text-sm text-emerald-800 flex gap-2 items-start">
                ...
                <div class="grid grid-cols-2 gap-6">
                    <div>
                        ...
                        <input type="text" name="EmployeeID" value="${emp?.EmployeeID || ''}" 
                            class="form-input w-full rounded-lg border-slate-300 shadow-sm focus:border-emerald-500 focus:ring-1 focus:ring-emerald-500 ${isEdit ? 'bg-slate-100 text-slate-500 cursor-not-allowed' : ''}" 
                    ...
                    <div>
                        ...
                        <input type="text" name="EmployeeName" value="${emp?.EmployeeName || ''}" 
                            class="form-input w-full rounded-lg border-slate-300 shadow-sm focus:border-emerald-500 focus:ring-1 focus:ring-emerald-500" 
                ...
                <div class="grid grid-cols-2 gap-6">
                    <div>
                        ...
                        <div class="relative">
                            <select name="Department" class="form-select w-full rounded-lg border-slate-300 shadow-sm focus:border-emerald-500 focus:ring-1 focus:ring-emerald-500 appearance-none">
                    ...
                    <div>
                        ...
                        <div class="relative">
                            <select name="Position" class="form-select w-full rounded-lg border-slate-300 shadow-sm focus:border-emerald-500 focus:ring-1 focus:ring-emerald-500 appearance-none">
                ...
                <div>
                    ...
                    <select name="Role" class="form-select w-full rounded-lg border-slate-300 bg-slate-50 shadow-sm focus:border-emerald-500 focus:ring-1 focus:ring-emerald-500">
